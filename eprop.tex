...
When comparing the performance of models trained with eProp on the SHD dataset with results obtained using BPTT~\citep{Zenke2021a} we found no clear differences \todo{suitable significance test?} for the \num{256} neuron models (figure~\ref{fig:shd_performance}). 
